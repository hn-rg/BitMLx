...
compileWithdrawC :: Coins c => CompilerSettings c -> [(P, (Rational, Rational))] -> Either CompilationError (Contract c)
...
compileWithdrawD :: Coins c => CompilerSettings c -> [(P, (Rational, Rational))] -> Either CompilationError (Contract c)
